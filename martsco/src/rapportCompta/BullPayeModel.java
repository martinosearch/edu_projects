...
import salaire.SalaireComputer;

public class BullPayeModel {
	private int page;
	...
	public void writeRecu(Operation op) {
		...
		progress.getLoading(pFrame, "Traitement en cours, prennez votre mal en patience");
		...
		while (page < 2) {
			...
			AgentSalaire agentSal = operation.getAgentSalaire();
			...
			htmlBody += "<table class='ficheNoteExemplaire' width='100%'>"
					+ "<tr><td class='tdB'><b>Reférence</b></td><td class='tdSBL'>" + operation.getNumOperation()
					+ "</td></tr>" + "<tr><td class='tdB'><b>Nom et Prénoms de l'Agent</b></td><td class='tdSBL'>"
					+ agentSal.decrisToi() + "</td></tr>"
					+ "<tr><td class='tdSBT'><b>N° Mle</b></td><td class='tdBInf'></td></tr>"
					+ "<tr><td class='tdSBT'><b>Code</b></td><td class='tdBInf'>" + agentSal.getCodeInfo()
					+ "</td></tr>" + "<tr><td class='tdSBT'><b>Montant payé</b></td><td class='tdBInf'>"
					+ operation.getMontant() + " " + Constance.getDeviseMonaie() + "</td></tr>"
					+ "<tr><td class='tdSBT'><b>En lettres</b></td><td class='tdBInf'>" + computer.getMontantEnLettres()
					+ "</td></tr>" + "<tr><td class='tdSBT'><b>Justification</b></td><td class='tdBInf'>"
					+ operation.getJustification() + "</td></tr>" + "</table>";
			...
			htmlBody += "<table class='ficheNoteExemplaire' width='100%'>"
					...
					+ formatter.print(operation.getDate()) + "</b></td></tr>"
					+ "<tr><td class='tdSB'><b></b></td><td class='tdSB'><b></b></td></tr>"
					+ "<tr><td class='tdSB'><b></b></td><td class='tdSB'><b><u>La Direction</u></b></td></tr>"
					+ "<tr><td class='tdSB'><b></b></td><td class='tdSB'><b></b></td></tr>"
					+ "<tr><td class='tdSB'><b></b></td><td class='tdSB'><b></b></td></tr>"
					+ "<tr><td class='tdSB'><b></b></td><td class='tdSB'><b>" + charge.decrisToi() + "</b></td></tr>";
			htmlBody += "</table>";
		}
	...
	private String writePied() {
		...
		return bs.writeCode(operation.getNumOperation(), "",
