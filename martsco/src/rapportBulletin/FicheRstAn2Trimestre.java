...
public class FicheRstAn2Trimestre extends FicheRstAn2 {
	...
	public void write() {
		...
		htmlBody += "<br/>" + "<table width=100% class='tabSB'>" + "<tr"
				+ "<td class='tdBC' width=100% align=center>"
				+ "<div id='titre'>" + titre + "</div></td>" + "</tr>" + "<tr"
				+ "<td class='tdSB'>";
		...
		if (model == Rapport.MODEL_SECOND) {// pour le secondaire
			htmlBody += "<table width=100% class='tabSB'>"
					...
					+ "<td class='tdSBLC' width=50%>Moy. 1er trim</td>"
					+ "<td class='tdSBLC' width=50%>Moy. 2è trim</td>"
					+ "<td class='tdSBLC' width=50%>Moy. 3è trim</td>"
