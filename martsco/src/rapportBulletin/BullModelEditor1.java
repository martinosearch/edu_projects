...
public class BullModelEditor1 extends BullWriterModel {

	private int nbrcol;

	public BullModelEditor1() {
	...
	private void writeIdEleve() {
		htmlBody += "<div id='blocidentites'>" + "<table class='tabB' width='100%'>" + "<tr>"
				+ "<td id='ideleve' width='85%'>" + "<div id='nom'><span id='titrePre'>Nom et Prénoms: </span>"
				+ eleve.getNom() + " &#160;" + " &#160; " + eleve.getPrenom() + "</div>"
				+ "<div><span id='titrePre'>Sexe: </span>" + eleve.getSexe() + "</div>"
				+ "<div><span id='titrePre'>Code: </span>" + eleve.getCodeInfo()
				+ "<span id='titrePre'>&#160; &#160; &#160; Statut: </span>&#160;" + statut + "</div>"
				+ "<div><span id='titrePre'>Classe: </span>" + eleve.getClasse()
				+ "<span id='titrePre'>&#160; &#160; &#160; Effectif: </span>&#160;" + effectif + "</div></td>"
	...
	private void writeEntete() {
		...
		String dec = decoupage.toString().toUpperCase();
		htmlBody += bs.writeEntete("BULLETIN DE NOTES DU " + dec);
	}
