...
public class StyleReleve extends MartStyle {
	...
	public StyleReleve() {
		...
		if (Constance.LOGO_FOND == true) {
			add(".cadre{height:100%;width:100%;"
		...
		add("body{" + "background-image:none;}");

		add("#image{border:1pt black none;" + "text-align:center;"
				+ "padding:0pt;" + "font-size:10pt;"
				+ "boder-collapse:collapse;" + "layout:fixed;}");

		// les adresses
		add("#ministere{font-size:9pt;" + "font-family:'Tahoma';"
				+ "border:1pt black none;" + "vertical-align:top;"
				+ "text-align:center;" + "padding:0pt;}");

		add("#ministere_releve{font-size:7pt;"
				+ "font-family:'bookman old style';" + "border:1pt black none;"
		...
		add("#adresse1{font-size:12pt;" + "font-family:'Tahoma';"
		...
		add("#titre{font-size:12pt;" + "font-family:'Tahoma';"
		...
		add("#titreCdSmall{font-size:10pt;"
		...
		add("#ideleve{border: .5pt black solid;"
				...
				+ "font-size:9pt;" + "font-family:'bookman old style';"
				+ "font-weight:bold;" + "font-style:normal;" + "padding:0pt;"
				+ "border-collapse:collapse;}");

		add("#nom{" + "font-size:14pt;" + "font-family:'bookman old style';"
				+ "font-weight:bold;" + "font-style:normal;}");

		add("#textNormal{" + "font-size:8pt;"
		...
		// notes rel
		add("#notesRel{padding:0pt;" + "font-size:9pt;" + "font-family:'"
				+ policeNote + "';" + "}");
		...
		add("#codebar{text-align:left;" + "padding:1pt;" + "font-size:9pt;"
