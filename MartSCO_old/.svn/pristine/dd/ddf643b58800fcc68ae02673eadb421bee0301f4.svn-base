...
public class SectionMatiere extends MartFrame implements Observer {
	...
	public SectionMatiere(String an) {
		setTitle("Section d'une Matière");
		setSize(900, 350);
	...
	private void initComponent() {
		...
		lbIntitule = new JLabel("Ancienne Matière");
		cbMatiere = new JComboBox();
		lbSection1 = new JLabel("1ère Section");
		cbSection1 = new JComboBox();
		lbSection2 = new JLabel("2è Section");
		cbSection2 = new JComboBox();

		for (Matiere mat : matieres) {
			cbMatiere.addItem(mat.getIntitule());
			cbSection1.addItem(mat.getIntitule());
			cbSection2.addItem(mat.getIntitule());
		}
		...
		panIntitule.add(cbMatiere);
		panIntitule.add(lbSection1);
		panIntitule.add(cbSection1);
		panIntitule.add(lbSection2);
		panIntitule.add(cbSection2);
	...
	public static void main(String[] args) {
		new SectionMatiere("2016-2017").setVisible(true);
	}
	...
	public String getSection1() {
		return (String) cbSection1.getSelectedItem();
	}

	public String getSection2() {
		return (String) cbSection2.getSelectedItem();
	}
}
