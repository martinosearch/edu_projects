...
public class StyleBulletin extends MartStyle {
	...
	if (Constance.LOGO_FOND == true) {
	    add(".cadre{height:100%;" + "width:100%;" + "border: 1pt blue none;" + "padding:0pt;" + "background-image:"
		    + Glogo.toURI() + ";" + "background-repeat:no-repeat;" + "background-position:center;}");
	} else {
	    add(".cadre{height:100%;" + "width:100%;" + "border: 1pt blue none;" + "padding:0pt;"
		    + "text-align:center;}");
	}
	...
	// notes
	add("#notes{border: 1pt blue solid; padding:0pt;" + "font-size:10pt;" + "font-family:'" + policeNote + "';}");
