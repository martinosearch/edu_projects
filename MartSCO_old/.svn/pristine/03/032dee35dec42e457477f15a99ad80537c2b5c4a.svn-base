...
public class ListeAnonymat implements Observer {
	...
	private synchronized void createRapport(MartList<EleveClasse> listeSalle,
		...
		htmlBody += "<table width=100% class='tabSB'>" + "<tr id='ficheNote'>"
				+ "<td class='tdBC' width=50%>N° Table</td>"
				+ "<td class='tdSBLC' width=50%>Numéro d'anonymat</td></tr>";
		...
		preview.addObserver(ListeAnonymat.this);
	...
	public static void main(String[] args) {
		...
		ListeAnonymat fr = new ListeAnonymat();
