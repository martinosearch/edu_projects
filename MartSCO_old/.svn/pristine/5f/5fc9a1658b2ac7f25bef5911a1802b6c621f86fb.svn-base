...
public class SalaireGeneralVoid {
	...
	private DAO andao, clsdao, elvclsdao, versdao, opdao;
	private MartList<Classe> classes;
	private String classe;

	public SalaireGeneralVoid() {
		andao = DAOFactory.getDAO(DAO.ANNEE);
		clsdao = DAOFactory.getDAO(DAO.CLASSE);
		elvclsdao = DAOFactory.getDAO(DAO.ELEVE_CLASSE);
		versdao = DAOFactory.getDAO(DAO.VERSEMENT_ECOLAGE);
		opdao = DAOFactory.getDAO(DAO.OPERATION);
	}

	public void listeEcolage() {
	...
	public void listeFraisInscription() {
	...
	public static void main(String[] args) {
		...
		new SalaireGeneralVoid().listeCompteEntree();
	}
